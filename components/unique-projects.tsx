...
const projects = [
  {
    ...
    tags: ["React", "Node.js", "MongoDB", "Express", "Socket.io", "Jitsi", "Redux"],
    link: "#",
    github: "#",
  },
  {
    ...
    tags: ["React", "Node.js", "MongoDB", "Express", "WebRTC", "Jitsi", "Stripe"],
    link: "#",
    github: "#",
  },
  {
    ...
    tags: ["React", "Node.js", "MongoDB", "Express", "Stripe", "AWS S3", "Redis"],
    link: "#",
    github: "#",
  },
]
...
export function UniqueProjects() {
  ...
  return (
    <section id="projects" ref={sectionRef} className="min-h-screen px-6 md:px-12 lg:px-24 lg:pl-48 py-24">
      <div className="max-w-7xl w-full mx-auto">
        <div className="mb-16">
          <span className="text-sm font-mono text-primary">04 — Projects</span>
          <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold mt-4">Selected Work</h2>
        </div>
            ...
            <div key={index} className="project-item">
              <div className="grid lg:grid-cols-12 gap-8 lg:gap-12">
                <div className="lg:col-span-2">
                  <span className="text-6xl font-bold text-muted-foreground/20">{project.number}</span>
                </div>

                <div className="lg:col-span-10 space-y-6">
                  <div>
                    <h3 className="text-4xl md:text-5xl font-bold mb-2">{project.title}</h3>
                    <p className="text-xl text-accent italic">{project.subtitle}</p>
                  </div>
